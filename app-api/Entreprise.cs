...
namespace app_api
{
    ...
    {
        string token;
        public Entreprise(string token)
        {
            InitializeComponent();
            this.token = token;
         }
        ...
        private async void button1_Click(object sender, EventArgs e)
        {
            ...
            using (HttpClient client = new HttpClient())
            {
                try
                {
                    string uri = $"https://s4-8001.nuage-peda.fr/Innov-Anglais/public/api/companies";
        ...
        private async void button2_Click(object sender, EventArgs e)
        {
            using (HttpClient client2 = new HttpClient())
            {
                try
                {
                    string uri2 = $"https://s4-8001.nuage-peda.fr/Innov-Anglais/public/api/companies";
